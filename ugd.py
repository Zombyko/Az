...
#User Agnes buatan Asep Yusup 
    ...
    dua  = f"Mozilla/5.0 (Linux; U; Android {str(rr(5,12))}; es-es; SM-T110 Build/JDQ39) AppleWebKit/534.30 (KHTML, seperti Gecko) Versi/ {str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Safari/534.30 [FB_IAB/Orca-Android;FBAV/339.0. 0.18.118;]"
